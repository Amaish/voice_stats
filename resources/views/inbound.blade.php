...
//   CURLOPT_URL => "http://134.213.238.76:8080/voice/inbound/success?granularity=day&startDate=2019-01-22&endDate=2019-01-22&metric=duration&currencyCode=KES",
...
// foreach(array_keys($users) as $user){
    ...
    curl_setopt_array(
        $curl, array(
        CURLOPT_URL => "http://134.213.238.76:8080/voice/outbound/success?granularity=day&startDate=2019-01-20&endDate=2019-01-22&metric=duration&currencyCode=KES&username=betpawa",
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_CUSTOMREQUEST => "GET",
        CURLOPT_HTTPHEADER => array(
            "ApiKey: 5afe31f1daa3de899c690f0172a719cee1f59e0a3251ec432f021c81b4d87ffd"
    ...
    echo "<pre>";
    $dates= $newjsonDecoded["responses"]["phoneNumberStats"];
